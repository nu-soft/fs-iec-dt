namespace System
  ...
  /// <remarks>An abbreviation for the IEC 61131 type LWORD.</remarks>
  type LWORD  = uint64
  ...
  module Operators =
    ...
    /// static conversion method on the input type.</summary>
    /// <param name="value">The input value.</param>
    /// <returns>The converted LWORD</returns>
    [<CompiledName("ToLWORD")>]
    val inline LWORD : value:^T -> LWORD        when ^T : (static member op_Explicit : ^T -> LWORD)        
  ...
  module MeasureOperators =
    ...
    /// <summary>Creates a WORD value with units-of-measure</summary>
    ...
    /// <summary>Creates a DWORD value with units-of-measure</summary>
    ...
    /// <summary>Creates a LWORD value with units-of-measure</summary>
    /// <param name="LWORD">The input LWORD.</param>
    /// <returns>The LWORD with units-of-measure.</returns>
    val inline LWORDWithMeasure  : LWORD -> LWORD<'Measure> 
    
    /// <summary>Creates a SINT value with units-of-measure</summary>
    ...
    /// <summary>Creates a USINT value with units-of-measure</summary>
