...
let project = "NuSoft.FSharp.IEC.DataTypes"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "IEC-61131-3 type aliases for F#"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "IEC-61131-3 type aliases for F#"

// List of author names (for NuGet package)
let author = "Pawel Paluch (@ppaluch)"

// Tags for your project (for NuGet package)
let tags = "IEC FSharp"

// File system information
let solutionFile  = "NuSoft.FSharp.IEC.DataTypes.sln"
...
let gitHome = sprintf "%s/%s" "https://github.com/nu-soft/fs-iec-dt/tree/scaffold-migration" gitOwner

// The name of the project on GitHub
let gitName = "fs-iec-dt"

// The url for the raw files hosted
let gitRaw = Environment.environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/nu-soft/fs-iec-dt/scaffold-migration/nu-soft"

let website = "/fs-iec-dt"
...
let info =
  [ "project-name", "NuSoft.FSharp.IEC.DataTypes"
    "project-author", "Pawel Paluch (@ppaluch)"
    "project-summary", "IEC-61131-3 type aliases for F#"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/NuSoft.FSharp.IEC.DataTypes" ]
